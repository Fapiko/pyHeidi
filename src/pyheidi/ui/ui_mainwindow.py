...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableTabs = QtGui.QTabWidget(self.tableTab)
        ...
        self.verticalLayout_5.addWidget(self.tableTabs)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/resources/icons/add.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.addColumnButton.setIcon(icon6)
        ...
        self.removeColumnButton = QtGui.QPushButton(self.tableTab)
        self.removeColumnButton.setEnabled(False)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/resources/icons/delete.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.removeColumnButton.setIcon(icon7)
        ...
        self.moveColumnUpButton = QtGui.QPushButton(self.tableTab)
        self.moveColumnUpButton.setEnabled(False)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/resources/icons/resultset_up.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.moveColumnUpButton.setIcon(icon8)
        ...
        self.moveColumnDownButton = QtGui.QPushButton(self.tableTab)
        self.moveColumnDownButton.setEnabled(False)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/resources/icons/resultset_down.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.moveColumnDownButton.setIcon(icon9)
        ...
        self.discardTableButton = QtGui.QPushButton(self.tableTab)
        ...
        self.saveTableButton = QtGui.QPushButton(self.tableTab)
        ...
        self.tableTabs.setCurrentIndex(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tableName.setPlaceholderText(QtGui.QApplication.translate("MainWindow", "Enter table name", None, QtGui.QApplication.UnicodeUTF8))
        self.label_3.setText(QtGui.QApplication.translate("MainWindow", "Comment:", None, QtGui.QApplication.UnicodeUTF8))
        self.tableTabs.setTabText(self.tableTabs.indexOf(self.tableTabsBasic), QtGui.QApplication.translate("MainWindow", "Basic", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.removeColumnButton.setText(QtGui.QApplication.translate("MainWindow", "Remove Column", None, QtGui.QApplication.UnicodeUTF8))
        self.moveColumnUpButton.setText(QtGui.QApplication.translate("MainWindow", "Up", None, QtGui.QApplication.UnicodeUTF8))
        self.moveColumnDownButton.setText(QtGui.QApplication.translate("MainWindow", "Down", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.discardTableButton.setText(QtGui.QApplication.translate("MainWindow", "Discard", None, QtGui.QApplication.UnicodeUTF8))
        self.saveTableButton.setText(QtGui.QApplication.translate("MainWindow", "Save", None, QtGui.QApplication.UnicodeUTF8))
